    ...
    it 'submits the unit to fleet' do
      expected_unit = {
        ...
        'Service' =>         { 'User' => 'root',
                               ...
                               'ExecStart' => '/opt/bin/systemd-docker run -P --rm --name awesome_0.0.1_e37496243_web-%i -e FOO=bar -e BAZ=qux.com -e PORT=3333 quay.io/assemblyline/awesome:0.0.1 bin/puma', # rubocop:disable Metrics/LineLength
                               'Restart' => 'always',
                               'RestartSec' => '10s',
                               'Type' => 'notify',
                               'NotifyAccess' => 'all',
    ...
    it 'submits a sidekick unit to fleet' do
      expected_sidekick = {
        ...
        'Service' =>         { 'User' => 'root',
                               ...
                               'ExecStart' => '/opt/bin/systemd-docker run -P --rm --name awesome_0.0.1_e37496243_web_sidekick-%i -e CONTAINER_NAME=awesome_0.0.1_e37496243_web-%i -e CONTAINER_PORT=3333 quay.io/assemblyline/sidekicks vulcand', # rubocop:disable Metrics/LineLength
                               'Restart' => 'always',
                               'RestartSec' => '10s',
                               'Type' => 'notify',
                               'NotifyAccess' => 'all',
